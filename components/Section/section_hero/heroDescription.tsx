...
export default function HeroDescription({ page }: any) {
  return (
    <div className="bg-black border border-neutral-800 p-10 rounded-3xl shadow-2xl text-white max-w-2xl">
      <div className="flex flex-col gap-6">
        <span className="font-semibold tracking-wider uppercase text-sm text-yellow-500">Bienvenue chez Marcel Click & Services</span>
