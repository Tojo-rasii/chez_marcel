...
export function FlipCard({ data }: FlipCardProps) {
  ...
  return (
    <div
      className="mt-2 relative w-40 h-60 md:w-60 md:h-70 perspective-1000 cursor-pointer mx-auto"
      onClick={handleClick}
    ...
    >
      ...
      >
        ...
        <div className="px-6 hidden flex items-center justify-between w-full">
          <div>
